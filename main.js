...
$(function () {
    ...
    var ajaxSettings = {
      "async": true,
      "crossDomain": true,
      "url": "https://signiflyproject-6577.restdb.io/rest/signiflyform",
      "method": "POST",
      "headers": {
        "x-apikey": apikey,
    ...
    var ajaxSettingsAttachments = {
       "async": true,
       "url": "https://signiflyproject-6577.restdb.io/media",
       "method": "POST",
       "contentType": false,
       "headers": {
         "x-apikey": apikey
    ...
    function postForm() {
      ...
      // clear errors
      $("#signiflyform-form .has-error").removeClass("has-error");
      $("#signiflyform-form .help-block").remove();
   ...
   // get the form data
      var formObj = $("#signiflyform-form").serializeObject();
  
      // get attachments from inputs
      var attachments = [];
  
      $("#signiflyform-form input[data-type=file], #signiflyform-form input[data-type=image]").each(function(input){
        ...
        .done(function(){
         ...
         ajaxSettings.data = JSON.stringify(formObj);
          ...
          .done(function (response) {
            ...
            $("#signiflyform-form").replaceWith("<div class='thank-you'>"+successMessage+"</div>");
          })
    ...
    $("#signiflyform-form").submit(function (event) {
          postForm();
